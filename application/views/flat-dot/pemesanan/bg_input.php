		...
		<div class="box-content">
			<?php echo form_open("dashboard/pemesanan/simpan",'class="form-horizontal" name="frm_pesan"'); ?>
			  <fieldset>
				...
				<div class="control-group">
				  <label class="control-label">Blok Rumah</label>
				  <div class="controls">
					<input type="text" class="input-xlarge" id="blok_rumah" name="blok_rumah" required />
				  </div>
				</div>
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					<input type="text" class="input-xlarge" id="no_rumah" name="no_rumah" required />
				  </div>
				</div>
				...
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
					<thead>
						<tr>
							...
							<th>Harga Satuan</th>
							<th>Subtotal</th>
							<th><a href="<?php echo base_url(); ?>dashboard/pemesanan/tambah_item" class="cbbarang btn btn-warning btn-small">Tambah Transaksi</a></th>
						</tr>
					</thead> 
					<?php $i = 1; $no=1;?>
				...
				<div class="control-group">
				  <label class="control-label">Dibayarkan</label>
				  <div class="controls">
